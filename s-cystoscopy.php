...
<html>
  <head>
    <meta charset="utf-8">
    <title>Pediatric Cystoscopy</title>
    ...
    <div class="banner-head single-header">
      <div class="container-fluid">
        <div class="row text-center">
          <div class="col-md-12">
            <h2>Pediatric Cystoscopy</h2>
            <ol class="breadcrumb">
              <li><a href="index.php">Home</a></li>
              <li><a href="services.php">Services</a></li>
              <li class="active">Pediatric Cystoscopy</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-8">
          <div class="tab-content">
            <div id="home" class="tab-pane fade in active">
              ...
              <p class="text-justify"><b>After-surgery care : </b>You will be able to take your child home after he or she is fully awake. You may see small amounts of blood in your child's urine. This is normal. It is also normal for your child to have an increased need to urinate. Your child may also have burning or mild discomfort in his or her bladder or kidney area during urination.</p>
            </div>
          </div>
        </div>
        </div>
