...
<html>
  <head>
    <meta charset="utf-8">
    <title>Paediatric Oncosurgery</title>
    ...
    <div class="banner-head single-header">
      <div class="container-fluid">
        <div class="row text-center">
          <div class="col-md-12">
            <h2>Paediatric Oncosurgery</h2>
            <ol class="breadcrumb">
              <li><a href="index.php">Home</a></li>
              <li><a href="services.php">Services</a></li>
              <li class="active">Paediatric Oncosurgery</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-8">
            <div class="tab-content">
              <div id="home" class="tab-pane fade in active">
                ...
                <p class="text-justify"><b>We offer surgeries for - </b></p>
                <ul>
                  <li>Wilm’sTumor</li>
                  <li>Neuroblastoma</li>
